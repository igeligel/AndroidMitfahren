...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedEntry.TABLE_NAME + " (" +
                    ...
                    FeedEntry.COLUMN_NAME_YEAR + INTEGER_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_NAME_MONTH + INTEGER_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_NAME_DAY + INTEGER_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_NAME_HOUR + INTEGER_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_NAME_MINUTE + INTEGER_TYPE + COMMA_SEP +
